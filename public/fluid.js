...
`);
    ...
    document.body.addEventListener('touchstart', handleTouchStartOnce, { once: true });
    ...
    return () => {
        ...
        document.body.removeEventListener('mousemove', handleMouseMoveOnce);
        window.removeEventListener('mousemove', handleMouseMove);
        document.body.removeEventListener('touchstart', handleTouchStartOnce);
...
window.dispatchEvent(new Event('fluidReady'));