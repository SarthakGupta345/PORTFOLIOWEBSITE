      ...
      <div className="relative z-10 w-full space-y-12">
        ...
        <div className="space-y-20 mb-16 mt-10">
          {projectOverviews.map((project, index) => (
            <div
              key={index}
              className="w-full max-w-6xl border-b border-neutral-200 dark:border-neutral-800 pb-12 mx-auto p-1 text-neutral-900 dark:text-neutral-100"
            >
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-7 w-full group relative">
                  ...
                  <div className="w-full aspect-[16/10] bg-gradient-to-tr from-rose-100 via-orange-50 to-red-100 dark:from-red-950/40 dark:via-neutral-900 dark:to-rose-950/30 rounded-2xl p-6 border border-neutral-200/60 dark:border-neutral-800 shadow-sm flex flex-col justify-between overflow-hidden relative">
                    ...
                    <div className="w-full h-[75%] bg-white dark:bg-neutral-950 rounded-xl shadow-xl border border-neutral-200 dark:border-neutral-800 flex flex-col overflow-hidden transform translate-y-2 group-hover:translate-y-1 transition-transform duration-300">
